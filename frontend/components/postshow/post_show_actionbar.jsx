...
function PostShowActionBar({ liked, createLike }) {
  console.log(liked)
  console.log(createLike)
  console.log('TESTING')
  // console.log(createLike.bind(this))
  // console.log(deleteLike)
  // console.log(props.createLike)
  // console.log(props)
  // const handleLike = () => {

  // }

  // not using this since trying to use no state in this component
  ...
  return (
    <section className="post-icons-bar">
      <span className="like-icon" >
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className={liked ? "feather-heart" : "feather"} onClick={'handleLike'} ><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
      </span>
      ...
      <span className="favorite-icon-container">
        ...
        <a>
          <div className={isSelected ? "favorite-icon-selected" : "favorite-icon"} onClick={'handleBookmark'} />
        </a>
        {/* </button> */}
      </span>
    </section>
